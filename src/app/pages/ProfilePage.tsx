...
export default function ProfilePage() {
  ...
  const { user, isAuthenticated, updateUser, deleteAccount, signOut } =
    useAuth();
  ...
  const rentedHouse = user?.rentedHouseId
    ? mockHouses.find((h) => h.id === user.rentedHouseId)
    : null;
  const rentedEstate = user?.rentedEstateId
    ? mockEstates.find((e) => e.id === user.rentedEstateId)
    : null;
  ...
  const handleSaveEmail = () => {
    if (!editEmail.includes("@"))
      return setEditError("Please enter a valid email");
  ...
  return (
    <div style={{ background: "#060d17", minHeight: "100vh" }}>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-5">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-4">
                <div
                  ...
                  style={{ background: "rgba(29,111,206,0.15)" }}
                >
                ...
                <div>
                  ...
                  >
                    {rentedEstate.name} · Unit {rentedHouse.houseNumber}
                  </p>
                  <p className="text-xs" style={{ color: "#64748b" }}>
                    {rentedEstate.location}
                  </p>
                </div>
              </div>
              <Link
        ...
        {/* Admin: add admin accounts - HIDDEN FOR SUPER ADMIN */}
        {user.isAdmin && !user.isSuperAdmin && (
          <div
            className="rounded-2xl p-6"
            style={{ background: "#0d1a2e", border: "1px solid #1e3a5f" }}
          >
            ...
            <p className="text-sm mb-4" style={{ color: "#64748b" }}>
              As estate admin, you can add up to 3 additional admin accounts to
              help manage your estate.
            </p>
            <button
        ...
        {!user.isSuperAdmin && (
          ...
          >
            <h3 className="mb-2" style={{ color: "#f87171", fontWeight: 700 }}>
              Danger Zone
            </h3>
            <p
            ...
            >
              Permanently delete your Communest account. This action cannot be
              undone and you will lose all data including your rental history.
            </p>
            <button
